...
export default function DungaoMotoPecas({ comercio }){
...
listarMotoboys()
  ...
  return (
    <>
      ...
      {/* HEADER */}
      <header className="w-full h-[60px] flex items-center justify-between gap-4 p-4 bg-blue-600">
  ...
  <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center px-4">
    <div className="bg-white rounded-2xl p-8 shadow-2xl text-gray-800 w-full max-w-md relative">
      ...
      <div className="divide-y divide-gray-200">
        {[
          { dia: 'Segunda-feira', horario: '8:00 às 18:00' },
          { dia: 'Terça-feira', horario: '8:00 às 18:00' },
          { dia: 'Quarta-feira', horario: '8:00 às 18:00' },
          { dia: 'Quinta-feira', horario: '8:00 às 18:00' },
          { dia: 'Sexta-feira', horario:'8:00 às 18:00' },
...
{mostrarFinalizados && (
  ...
  <span className="text-xl text-green-700 font-semibold">
    Troco para: R$ {Number(pedido.troco).toFixed(2)}
      ...
      {/* CAPA */}
      <section className="w-full h-[500px] p-4 bg-capa2 bg-cover bg-center relative flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center text-white text-center gap-4">
          ...
          <div className="text-base font-poppins font-light">
           {comercio.tempoRetirada}-{comercio.tempoEntrega} ● Valor Mínimo de servico R$ {comercio.taxaEntrega} ● Ver mais
          </div>
        </div>
      </section>

      {/* NAV COM SCROLL DAS CATEGORIAS */}
      <section className="w-full bg-blue-600 h-[60px] px-4 flex items-center justify-evenly">
        {showEsquerda ? (
          <button
            onClick={scrollLeft}
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  className="flex justify-between items-center cursor-pointer px-6 py-4 text-blue-600 font-semibold border-b-2 border-blue-600"
                >
